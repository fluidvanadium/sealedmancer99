...
async fn app() -> Result<u64, Error> {
    ...
    let query = Query::Custom(
        "(legal:vintage -t:stickers -o:sticker -t:attraction -o:attraction -o:sticker -o:commander) or (name:/^a-/) or ('commander' -o:'your commander' o:'cast a commander') or 'Stone-Throwing Devils' or 'Pradesh Gypsies' or 'Shahrazad' or 'Downdraft' or 'Backdraft'".to_string(),
    );
